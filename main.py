...
class Main:
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.maze = Generator(self.width, self.height)
    ...
    def visualization(self):
        temp = Visualizer(self.width, self.height, self.maze)
        return temp
    ...
    def solve(self):
        ...
        self.mazeSolver.fillGraph(self.maze.nodes, self.maze.edgeWeights)
